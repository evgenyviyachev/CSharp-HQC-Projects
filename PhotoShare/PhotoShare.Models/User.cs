namespace PhotoShare.Models
{
    ...
    {
        [NotMapped]
        public static int? idOfLoggedUser = null;
        ...
        [Required]
        [Password(6, 50, ContainsSpecialSymbol = true, ContainsDigit = true, ContainsUppercase = true, ContainsLowercase = true, ErrorMessage ="Invalid password")]
